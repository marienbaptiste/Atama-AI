...
前は機械の会社で働いていました。四十歳のとき、日本語を教える仕事に変わりました。だから、文法の名前より、実際に使う場面のほうを大事にします。「この言い方は、会社の人に使いますか」とよく聞きます。

山登りが好きで、月に一度は行きます。魚釣りも好きですが、あまり釣れません。お酒は少しだけ。朝は早く起きて、犬と散歩します。犬の名前は「クロ」です。

話し方は、静かで、少し無口です。ほめるときは短く「いいですね」とだけ言います。でも、間違いはきちんと直します。学生が言いたいことを、最後まで待って聞きます。急がせません。

説明するときは、たとえ話を使います。むかしの仕事の話をすることもあります。英語は少し話せますが、あまり得意ではありません。
